...
{
strcpy(cards[0].id,"12535471");
strcpy(cards[0].name,"aaaa");

strcpy(cards[1].id,"00332069");
strcpy(cards[1].name,"bbbb");

strcpy(cards[2].id,"12606747");
strcpy(cards[2].name,"cccc");
} 
